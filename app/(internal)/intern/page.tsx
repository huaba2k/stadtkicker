...
import { 
  ...
  FaBirthdayCake, FaRunning, FaGlassCheers, FaTrophy, FaMapMarkerAlt
} from "react-icons/fa";
...
export default function InternPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      // 3. News
      try {
        const newsQuery = `*[_type == "post" && isInternal == true] | order(publishedAt desc)[0..1] { _id, title, slug, publishedAt }`;
